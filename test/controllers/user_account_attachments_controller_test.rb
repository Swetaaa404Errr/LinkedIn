...
class UserAccountAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_account_attachment" do
    assert_difference('UserAccountAttachment.count') do
      post user_account_attachments_url, params: { user_account_attachment: { certificate: @user_account_attachment.certificate, user_account_id: @user_account_attachment.user_account_id } }
    end
  ...
  test "should update user_account_attachment" do
    patch user_account_attachment_url(@user_account_attachment), params: { user_account_attachment: { certificate: @user_account_attachment.certificate, user_account_id: @user_account_attachment.user_account_id } }
